...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1641.0, 1160.0, 57.0, 22.0 ],
					"text" : "/synth $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 725.0, 114.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 156.0, 219.0, 114.0, 20.0 ],
					"text" : "LEFT ACTIVE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.5, 694.0, 111.0, 22.0 ],
					"text" : "set RIGHT ACTIVE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 657.0, 103.0, 22.0 ],
					"text" : "set LEFT ACTIVE"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.0, 600.0, 44.0, 22.0 ],
					"text" : "sel 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 532.0, 222.0, 22.0 ],
					"text" : "if ($i1 >= 2) && ($i1 <= 10) then 2 else 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 499.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 529.5, 892.0, 97.5, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 193.0, 196.0, 113.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 628.5, 891.0, 35.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 156.0, 195.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 668.0, 891.0, 167.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 605.0, 853.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 829.0, 29.5, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 605.0, 725.0, 59.0, 22.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 605.0, 758.0, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 605.0, 794.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 164.0, 600.0, 52.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 985.0, 87.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 184.0, 837.0, 125.0, 22.0 ],
					"text" : "makenote 60 133"
				}
